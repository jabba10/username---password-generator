  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="twitter:title" content="Multi-Factor Authentication Guide 2026 | AccessVaulted Security" />
        <meta
          ...
          <div className={styles.mfaTypesGrid}>
            {[
              ...
              <div key={index} className={styles.mfaTypeCard}>
                ...
                <h3 className={styles.mfaTypeTitle}>{type.title}</h3>
                <p className={styles.mfaTypeDescription}>{type.description}</p>
